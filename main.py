...
if app_mode == "Home":
    ...
    This project uses Deep Learning (CNN) and TensorFlow
    to identify diseases in crop leaves.
...
# --------------------------------------------------
    ...
    To help farmers and researchers quickly identify
    plant diseases using Artificial Intelligence.
    """)
...
# --------------------------------------------------
    ...
    try:
        ...
        st.error(
            f"Could not load training history: {e}"
>>>>>>> 3095f700fca2265ea905ae1af8b60886dd1869ad
        )